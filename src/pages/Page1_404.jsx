    ...
    return (
        <div className = " fixed bg-slate-300 w-screen h-screen flex text-center left-0 top-0 z-10 overflow-hidden items-center justify-center py-5 px-7">
            ...
            <div>
                ...
                <div className = "my-4">
                    <Link className = " cursor-pointer px-3 py-2.5 text-white bg-purple rounded-lg mx-1" to = "/">Go back home</Link>
                    <Link className = "mx-1">
                    <span>Contact support </span>
                    <span className="material-symbols-outlined translate-y-[30%]">arrow_right_alt</span></Link>
                </div>
                </div>
            </div>
        </div>
